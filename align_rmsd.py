...
# Modified by Corinn Durham, February 6, 2018
#
...
#if i change native/new to only the indices corresponding to monomer A, will this work?
...
#this will work independent of the dimensions of the new structure because it's still just n*3 dot 3*3.
        l_aligned = new_structure.dot(U)
    
        # Sum distances squared over each particle, and take the square root to 
        # return RMSD.
#will have to modify s.t. only RMSD of the three pseudoatoms of interest.
        square_sum = 0
